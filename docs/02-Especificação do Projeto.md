...
## `CAROLINA PINHO`
<img src="https://i.imgur.com/ld246SJ.png" > | Carolina Pinho, 29 anos                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
- Carolina Pinho tem 29 anos, reside em Uberlândia e é formada em administração. Solteira e não tem filhos. Possui uma loja de roupas recém aberta no bairro onde mora com seus pais e seu maior sonho é ter sua marca conhecida. Sua prioridade no momento é conseguir novos clientes e contratar um(a) funcionário(a) para revesar turnos na loja pois ela possui outro emprego como clt. Com a empresa muito nova no mercado não tem como comprometer uma parte da renda pagando um contador e ela também não tem experiência com gestão financeira. Sua ideia é fazer controle dos recursos utilizando alguma ferramenta como o excel ou algo parecido, onde ela tenha mais facilidade para administrar seu caixa.

## `MARCELO CARDOSO`
<img src="https://i.imgur.com/nBOzBn8.png"> | Marcelo Cardoso, 26 anos                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
## `VITÓRIA CAETANO`
<img src="https://i.imgur.com/dfMuSI2.png"> | Vitória Caetano, 25 anos                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| Ocupação                                                                                                                 | Microempresária, dona de uma loja física de acessórios e assistência técnica para celular. |
| Aplicativos preferidos                                                                                                   | WhatsApp, Instagram, Youtube e TikTok. |
| Motivações                                                                                                               | Gerar lucro, atender as necessidades dos clientes e fidelizá-los |
| Seus Hobbies                                                                                                             | Musculação, aulas de dança e ir em shows e eventos |
| Frustrações?                                                                                                             | Não conseguir ter o controle dos lucros e gastos da empresa|
...
## `WENDERSON FELIS`
<img src="https://i.imgur.com/dx0cE7g.png"> | Wenderson Felis, 39 anos                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
## `LUCAS FERNANDO`
<img src="https://i.imgur.com/TOC8Llt.png"> | Lucas Fernando, 29 anos                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
|RF-002| O site deve conter um gráfico de monitoramento de despesas por categoria|  ALTA |
...
|RF-007| O site deve mostrar qual valor foi utilizado para reinvestimentos |  ALTA |
|RF-008| O site deve conter a capacidade de registrar e controlar contas a pagar, com recursos de categorização e controle de prazos de pagamento |  ALTA |
|RF-009 O site deve ter uma página mostrando quais gastos fixos foram quitados e quais estão pendentes |  ALTA |
|RF-010| O site deve apresentar a relação entre produtos/serviços vendidos e o faturamento total obtido |  ALTA |
|RF-011| Permitir que o usuário cadastre, visualize, altere e exclua informações | ALTA |
|RF-012| O Site deve ter uma interface organizada e de fácil usabilidade |  MÉDIA |
|RF-013| O Site deve permitir o usuário a exportação das informações |  BAIXA |
|RF-014| Permitir que o anexe documentos/comprovantes de pagamento | BAIXA |
|RF-015| O site deve conter um painel de compromissos diários | BAIXA |
