...
document.getElementById('name').textContent = userPerfil.name;
document.getElementById('username').textContent = userPerfil.novoUser;
document.getElementById('email').textContent = userPerfil.novoEmail;
document.getElementById('password').textContent = userPerfil.novaSenha;
